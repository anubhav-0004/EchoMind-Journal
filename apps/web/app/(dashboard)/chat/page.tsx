...
export default function ChatPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I've read all your journal entries. Ask me anything — patterns in your mood, what you were feeling on a specific day, recurring themes, or anything you've written about.",
    },
  ])
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      <div style={{
        ...
        <div>
          <h2 style={{ margin: 0, fontSize: '18px', fontWeight: '400', color: '#1a2530' }}>
          ...
          {messages.map((msg, i) => (
            <div key={i} style={{
              ...
              <div style={{
                ...
                border: msg.role === 'assistant' ? '1px solid rgba(44,58,68,0.08)' : 'none',
                fontSize: '14px',
                lineHeight: '1.6',
      ...
      {messages.length === 1 && (
        <div style={{ padding: '0 24px 12px' }}>
          <div style={{ maxWidth: '700px', margin: '0 auto', display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
            {SUGGESTIONS.map(s => (
              <button
                key={s}
